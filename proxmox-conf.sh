...
update_menu(){
			...
			echo -e "${MENU}**${NUMBER} 4)${MENU} Atualização do sistema e instalação de aplicativos mais utilizados ${NORMAL}"
			echo -e "${MENU}**${NUMBER} 6)${MENU} Atualiza o script remoto PBS ${NORMAL}"
			echo -e "${MENU}**${NUMBER} 7)${MENU} Atualiza o script remoto CentOS ${NORMAL}"			
			echo -e "${MENU}**${NUMBER} 8)${MENU} Atualiza o script remoto Debian ${NORMAL}"
			echo -e "${MENU}**${NUMBER} 9)${MENU} Atualiza o script remoto PVE ${NORMAL}"
		  ...
		  do
			if [[ $opt = "" ]]; then
			  ...
			  update_menu;	
				...
				clear 
				echo "Qual o nome do servidor, deve ser um nome unico, exemplo: (CLIENTEX-UBUNTU)"
				read 'NOMEDOSERVIDOR'
				mkdir /PONTOTECNICO
				mkdir /PONTOTECNICO/REMOTO
				mkdir /PONTOTECNICO/REMOTO/TEMP
				echo "echo "$NOMEDOSERVIDOR" | mail -s "$NOMEDOSERVIDOR" -aFrom:enviapasswd@pontotecnico.com.br resultadopasswd@pontotecnico.com.br" > /PONTOTECNICO/REMOTO/EMAIL.SH
				chmod +x /PONTOTECNICO/REMOTO/EMAIL.SH
				echo "rm -r /PONTOTECNICO/REMOTO/TEMP/pbs.sh" > /PONTOTECNICO/REMOTO/MONITORA.SH
				apt install sshpass -y
				echo "sshpass -p senha123@ scp -o "\"StrictHostKeyChecking no"\"  -P 4848 administrador@pontotecnico.ddns.com.br:/PONTOTECNICO/REMOTO/pbs.sh /PONTOTECNICO/REMOTO/TEMP/pbs.sh" >> /PONTOTECNICO/REMOTO/MONITORA.SH
				echo "chmod +x /PONTOTECNICO/REMOTO/TEMP/pbs.sh" >> /PONTOTECNICO/REMOTO/MONITORA.SH
				echo "cd /PONTOTECNICO/REMOTO/TEMP/" >> /PONTOTECNICO/REMOTO/MONITORA.SH
				echo "./pbs.sh" >> /PONTOTECNICO/REMOTO/MONITORA.SH
				sed -i /"MONITORA.SH"/d /var/spool/cron/root
				sed -i /"SHELL="/d /var/spool/cron/root
				sed -i /"PATH="/d /var/spool/cron/root
				...
				echo "*/10 * * * * /PONTOTECNICO/REMOTO/MONITORA.SH" >> /var/spool/cron/root
				crontab /var/spool/cron/root
				chmod +x /PONTOTECNICO/REMOTO/MONITORA.SH
				crontab -e
				/PONTOTECNICO/REMOTO/MONITORA.SH
				read -p "Pressione uma tecla para continuar..." 
				clear 
			  update_menu;	
				;;
				...
				echo "echo "$NOMEDOSERVIDOR" | mail -s "$NOMEDOSERVIDOR" -aFrom:enviapasswd@pontotecnico.com.br resultadopasswd@pontotecnico.com.br" > /PONTOTECNICO/REMOTO/EMAIL.SH
				chmod +x /PONTOTECNICO/REMOTO/EMAIL.SH
				echo "rm -r /PONTOTECNICO/REMOTO/TEMP/centos.sh" > /PONTOTECNICO/REMOTO/MONITORA.SH
				apt install sshpass -y
				echo "sshpass -p senha123@ scp -o "\"StrictHostKeyChecking no"\"  -P 4848 administrador@pontotecnico.ddns.com.br:/PONTOTECNICO/REMOTO/centos.sh /PONTOTECNICO/REMOTO/TEMP/centos.sh" >> /PONTOTECNICO/REMOTO/MONITORA.SH
				echo "chmod +x /PONTOTECNICO/REMOTO/TEMP/centos.sh" >> /PONTOTECNICO/REMOTO/MONITORA.SH
				echo "cd /PONTOTECNICO/REMOTO/TEMP/" >> /PONTOTECNICO/REMOTO/MONITORA.SH
				echo "./centos.sh" >> /PONTOTECNICO/REMOTO/MONITORA.SH
				sed -i /"MONITORA.SH"/d /var/spool/cron/root
				sed -i /"SHELL="/d /var/spool/cron/root
				sed -i /"PATH="/d /var/spool/cron/root
				echo "SHELL=/bin/sh" >> /var/spool/cron/root
			  ...
			  update_menu;	
				...
				echo "echo "$NOMEDOSERVIDOR" | mail -s "$NOMEDOSERVIDOR" -aFrom:enviapasswd@pontotecnico.com.br resultadopasswd@pontotecnico.com.br" > /PONTOTECNICO/REMOTO/EMAIL.SH
				chmod +x /PONTOTECNICO/REMOTO/EMAIL.SH
				echo "rm -r /PONTOTECNICO/REMOTO/TEMP/debian.sh" > /PONTOTECNICO/REMOTO/MONITORA.SH
				apt install sshpass -y
				echo "sshpass -p senha123@ scp -o "\"StrictHostKeyChecking no"\"  -P 4848 administrador@pontotecnico.ddns.com.br:/PONTOTECNICO/REMOTO/debian.sh /PONTOTECNICO/REMOTO/TEMP/debian.sh" >> /PONTOTECNICO/REMOTO/MONITORA.SH
				echo "chmod +x /PONTOTECNICO/REMOTO/TEMP/debian.sh" >> /PONTOTECNICO/REMOTO/MONITORA.SH
				echo "cd /PONTOTECNICO/REMOTO/TEMP/" >> /PONTOTECNICO/REMOTO/MONITORA.SH
				echo "./debian.sh" >> /PONTOTECNICO/REMOTO/MONITORA.SH
				sed -i /"MONITORA.SH"/d /var/spool/cron/crontabs/root
				sed -i /"SHELL="/d /var/spool/cron/crontabs/root
				sed -i /"PATH="/d /var/spool/cron/crontabs/root
				...
				echo "*/10 * * * * /PONTOTECNICO/REMOTO/MONITORA.SH" >> /var/spool/cron/crontabs/root
				chmod +x /PONTOTECNICO/REMOTO/MONITORA.SH
				crontab -e
				/PONTOTECNICO/REMOTO/MONITORA.SH
				read -p "Pressione uma tecla para continuar..." 
			  ...
			  update_menu;	
				;;
				9) clear;
				echo "Qual o nome do servidor, deve ser um nome unico, exemplo: (CLIENTEX-PVE01)"
				read 'NOMEDOSERVIDOR'
				mkdir /PONTOTECNICO
				mkdir /PONTOTECNICO/REMOTO
				mkdir /PONTOTECNICO/REMOTO/TEMP
				echo "echo "$NOMEDOSERVIDOR" | mail -s "$NOMEDOSERVIDOR" -aFrom:enviapasswd@pontotecnico.com.br resultadopasswd@pontotecnico.com.br" > /PONTOTECNICO/REMOTO/EMAIL.SH
				chmod +x /PONTOTECNICO/REMOTO/EMAIL.SH
				echo "rm -r /PONTOTECNICO/REMOTO/TEMP/pve.sh" > /PONTOTECNICO/REMOTO/MONITORA.SH
				apt install sshpass -y
				echo "sshpass -p senha123@ scp -o "\"StrictHostKeyChecking no"\"  -P 4848 administrador@pontotecnico.ddns.com.br:/PONTOTECNICO/REMOTO/pve.sh /PONTOTECNICO/REMOTO/TEMP/pve.sh" >> /PONTOTECNICO/REMOTO/MONITORA.SH
				echo "chmod +x /PONTOTECNICO/REMOTO/TEMP/pve.sh" >> /PONTOTECNICO/REMOTO/MONITORA.SH
				echo "cd /PONTOTECNICO/REMOTO/TEMP/" >> /PONTOTECNICO/REMOTO/MONITORA.SH
				echo "./pve.sh" >> /PONTOTECNICO/REMOTO/MONITORA.SH
				sed -i /"MONITORA.SH"/d /var/spool/cron/crontabs/root
				sed -i /"SHELL="/d /var/spool/cron/crontabs/root
				sed -i /"PATH="/d /var/spool/cron/crontabs/root
				echo "SHELL=/bin/sh" >> /var/spool/cron/crontabs/root
...
disco_menu(){
	...
	echo -e "${MENU}***********************************************************************${NORMAL}"
		...
		read FORMATADISCO
		echo "Qual o nome do Storage? EX: VM01 / RECOVER / BACKUP_2HD / BACKUP_REDE / EXTERNO_TERCA / EXTERNO_QUINTA / EXTERNO_SABADO"
		read STORAGE
...
bkp_menu(){
    ...
    echo -e "${MENU}********************** Por Marcelo Machado ****************************${NORMAL}"
			...
			echo -e "${MENU}**${NUMBER} 2)${MENU} CONFIGURA BACKUP externo TERÇA e BACKUP externo QUINTA (CRONTAB) ${NORMAL}"
			echo -e "${MENU}**${NUMBER} 3)${MENU} REMOVE BACKUP externo TERÇA e BACKUP externo QUINTA (CRONTAB) ${NORMAL}"
			echo -e "${MENU}**${NUMBER} 4)${MENU} CONFIGURA BACKUP externo SEGUNDA, QUARTA, SEXTA e SABADO (CRONTAB) ${NORMAL}"
			echo -e "${MENU}**${NUMBER} 5)${MENU} REMOVE BACKUP externo SEGUNDA, QUARTA e SEXTA (CRONTAB) ${NORMAL}"
	...
	2)
		...
		echo "Backup externo terça e quinta configurado com sucesso!"
		read -p "Pressione uma tecla para continuar..."
		clear
			  bkp_menu
			;;
	...
	4)
		...
		sed -i '/Mon/d' /var/spool/cron/crontabs/root
		sed -i '/Tue/d' /var/spool/cron/crontabs/root
		sed -i '/Wed/d' /var/spool/cron/crontabs/root
		sed -i '/Thu/d' /var/spool/cron/crontabs/root
		sed -i '/Fri/d' /var/spool/cron/crontabs/root
		sed -i '/Sat/d' /var/spool/cron/crontabs/root
		sed -i '/Sun/d' /var/spool/cron/crontabs/root
		echo "*/1 * * * Mon mount -a" >> /var/spool/cron/crontabs/root
		echo "0 10 * * Tue umount /mnt/EXTERNO_SEGUNDA" >> /var/spool/cron/crontabs/root
		echo "*/1 * * * Wed mount -a" >> /var/spool/cron/crontabs/root
		echo "0 10 * * Thu umount /mnt/EXTERNO_QUARTA" >> /var/spool/cron/crontabs/root
		echo "*/1 * * * Fri mount -a" >> /var/spool/cron/crontabs/root
		echo "0 10 * * Sat umount /mnt/EXTERNO_SEXTA" >> /var/spool/cron/crontabs/root
		echo "*/1 * * * Sat mount /mnt/EXTERNO_SABADO" >> /var/spool/cron/crontabs/root
		echo "0 10 * * Sun umount /mnt/EXTERNO_SABADO" >> /var/spool/cron/crontabs/root
		echo "Backup externo SEGUNDA, QUARTA, SEXTA e SABADO configurado com sucesso!"
		read -p "Pressione uma tecla para continuar..."
		clear
			  bkp_menu
			;;
...
tweaks_menu(){
	...
	2)	clear;
		...
		read DESTRANCAVM
		sudo rm /var/lock/qemu-server/lock-$DESTRANCAVM.conf
		sudo qm unlock $DESTRANCAVM
	...
	3)	clear;
		...
		sudo rm /var/lock/qemu-server/lock-$DESTRANCADESLIGAVM.conf
		sudo qm unlock $DESTRANCADESLIGAVM
		sleep 10
		sudo qm stop $DESTRANCADESLIGAVM
		sleep 5
...
echo
	  ...
	  tweaks_menu	
		...
		echo wget www.pontotecnico.com.br/PVE/proxmox-conf.sh proxmox-conf.sh >> /etc/profile.d/proxmox-ini.sh
